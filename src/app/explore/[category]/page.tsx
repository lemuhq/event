...
import { isWebpackServerOnlyLayer } from "next/dist/build/utils";
...
export const eventsByCategory: Record<string, Event[]> = {
	ai: [
		{
			...
			description:
				"Join us for the premier AI event of the year! The AI & Machine Learning Summit brings together industry leaders, researchers, and practitioners for a day of deep learning, neural networks, and the future of artificial intelligence.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
				...
				description:
					"Leading organizer of technology conferences and summits in Silicon Valley.",
			},
		...
		},
		{
			...
			description:
				"A comprehensive workshop series exploring the ethical implications of AI development and deployment. Join us for interactive sessions, case studies, and expert panels.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
				...
				description:
					"AI Ethics researcher focused on responsible AI development.",
			},
		...
		},
		{
			...
			description:
				"Explore how AI is transforming healthcare delivery, from diagnosis to treatment planning. Features leading healthcare AI researchers and practitioners.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			description:
				"Hands-on workshop series covering the latest in deep learning. Perfect for developers and data scientists looking to enhance their skills.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			description:
				"Join leading ethicists and AI researchers for a discussion on the ethical implications of artificial intelligence and machine learning.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			description:
				"Discover how AI is transforming healthcare, from diagnosis to treatment planning and patient care.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			description:
				"Advanced workshop on reinforcement learning algorithms and their practical applications.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			description:
				"Watch innovative AI startups pitch their ideas to investors and industry experts.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			description:
				"Explore how AI is revolutionizing game development, from NPC behavior to procedural content generation.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			description:
				"Strategic overview of AI applications in business, focused on decision-making and implementation.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
	...
	"arts-culture": [
		{
			...
			description:
				"Experience the intersection of technology and art in this groundbreaking exhibition.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			location: {
				...
				coordinates: { lat: 42.3433, lng: -71.085 },
			},
			price: { amount: 75, currency: "US$" },
			description:
				"An evening of classical masterpieces performed by the renowned Boston Symphony Orchestra.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			description:
				"Watch live mural paintings, graffiti art demonstrations, and street performances.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			description:
				"An innovative dance performance exploring themes of human connection in the digital age.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			description:
				"Opening night of the international film festival featuring independent films.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			description:
				"Watch talented poets compete in this high-energy poetry slam event.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			description:
				"Guided tour of contemporary sculptures in a beautiful garden setting.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			description:
				"A spectacular evening of opera featuring world-renowned performers.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			description:
				"Experience cutting-edge interactive art installations using the latest technology.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
	...
	climate: [
		{
			...
			price: { amount: 150, currency: "US$" },
			description:
				"Join environmental leaders for a day of discussion and action on climate change.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			price: { amount: 75, currency: "US$" },
			description:
				"Learn about sustainable urban planning and green infrastructure development.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			description:
				"Explore solutions for ocean conservation and marine ecosystem protection.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			price: { amount: 0, currency: "US$" },
			description:
				"Discover the latest in renewable energy technology and sustainable power solutions.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			price: { amount: 35, currency: "US$" },
			description:
				"Practical tips and strategies for reducing waste and living sustainably.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			price: { amount: 50, currency: "US$" },
			description:
				"Showcase of innovative startups developing climate change solutions.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			description:
				"Discussion on forest preservation and sustainable forestry practices.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			price: { amount: 75, currency: "US$" },
			description:
				"Showcase of eco-friendly fashion and sustainable textile innovations.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			price: { amount: 25, currency: "US$" },
			description:
				"Discussion on environmental justice and equitable climate solutions.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			description:
				"Learn about sustainable architecture and green building practices.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
	...
	fitness: [
		{
			...
			price: { amount: 45, currency: "US$" },
			description:
				"A full day of outdoor fitness activities including HIIT workouts and yoga sessions.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			price: { amount: 85, currency: "US$" },
			description:
				"Professional marathon training session with experienced coaches.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			description:
				"Four-hour spinning event with multiple instructors and themed rides.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			description:
				"Indoor climbing workshop for beginners and intermediate climbers.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			description:
				"Learn proper swimming techniques from professional coaches.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			price: { amount: 35, currency: "US$" },
			description:
				"Advanced Pilates session focusing on core strength and flexibility.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			price: { amount: 50, currency: "US$" },
			description:
				"Learn effective functional training techniques for everyday fitness.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
	...
	wellness: [
		...
		},
		{
			...
			price: { amount: 45, currency: "US$" },
			description:
				"Experience the healing power of sound baths and crystal bowls.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			price: { amount: 75, currency: "US$" },
			description:
				"Learn about natural healing methods and holistic health practices.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			price: { amount: 65, currency: "US$" },
			description:
				"Learn to cook nutritious meals based on Ayurvedic principles.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			description:
				"Advanced breathing techniques for stress relief and energy.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			description:
				"Learn about different energy healing modalities and practices.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
	...
	crypto: [
		{
			...
			description:
				"Explore the latest developments in blockchain technology and cryptocurrency.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			description:
				"Hands-on workshop for building decentralized finance applications.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			price: { amount: 50, currency: "US$" },
			description:
				"Showcase of digital art and NFT collections from leading artists.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			description:
				"Learn advanced cryptocurrency trading strategies from experts.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			description:
				"Conference focused on Web3 development and blockchain integration.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			price: { amount: 75, currency: "US$" },
			description:
				"Explore the intersection of blockchain technology and gaming.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			description:
				"Discussion on cryptocurrency regulations and compliance.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			description:
				"Investment opportunities in metaverse and virtual worlds.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
		...
		},
		{
			...
			price: { amount: 125, currency: "US$" },
			description:
				"Learn about cryptocurrency mining operations and sustainability.",
			organizer: {
				id: "nathan-benaich",
				name: "Nathan Benaich (Air Street)",
				avatar:
		...
		},
		{
			...
			description:
				"How businesses can implement blockchain technology effectively.",
			organizer: {
				id: "sarah-chen",
				name: "Sarah Chen",
				avatar:
...
const categoryInfo = {
	ai: {
		...
		description:
			"Discover the latest in AI technology, machine learning, and data science.",
		socialLinks: {
			twitter: "#",
			linkedin: "#",
			website: "#",
	...
	"arts-culture": {
		name: "Arts & Culture",
		description:
			"Explore exhibitions, performances, and cultural events from around the world.",
		socialLinks: {
			instagram: "#",
			facebook: "#",
			website: "#",
	...
	climate: {
		name: "Climate Action",
		description:
			"Join the movement for environmental sustainability and climate solutions.",
		socialLinks: {
			twitter: "#",
			instagram: "#",
			website: "#",
	...
	fitness: {
		...
		description:
			"Get moving with workout sessions, training programs, and fitness challenges.",
		socialLinks: {
			instagram: "#",
			tiktok: "#",
			website: "#",
	...
	wellness: {
		...
		description:
			"Focus on mental health, meditation, and holistic well-being.",
		socialLinks: {
			instagram: "#",
			facebook: "#",
			website: "#",
	...
	crypto: {
		...
		description:
			"Stay updated on blockchain technology, crypto markets, and decentralized finance.",
		socialLinks: {
			twitter: "#",
			telegram: "#",
			website: "#",
...
export default function CategoryPage() {
	...
	const events =
		eventsByCategory[category as keyof typeof eventsByCategory] || [];
	const [selectedEvent, setSelectedEvent] = useState<string | null>(null);

	const { isLoading, data, isError } = useGetCategoryByIdQuery({
		id: category,
	});
		...
		<div className="min-h-screen bg-[#0A0A0B]">
			...
			<div className="max-w-7xl mx-auto px-4">
				<div className="flex items-center justify-between mb-8">
					...
					<Link
						href={"/events/create"}
						className="px-4 py-2 rounded-lg bg-neutral-800/50 text-white text-sm hover:bg-neutral-700/50 transition-colors"
					>
						+ Submit Event
					</Link>
				</div>
