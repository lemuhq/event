...
const events = [
	{
		...
		description:
			"Join us for the largest tech conference in the world with speakers from top companies.",
	...
	},
	{
		...
		description:
			"Discover new marketing strategies and network with professionals.",
			...
			<div className="mx-auto max-w-7xl px-6 lg:px-8">
					...
					{events.map((event) => (
						...
						>
							...
							<div className="p-6 flex-1 flex flex-col">
								...
								<div className="group">
									<h3 className="text-lg font-semibold leading-6 text-white group-hover:text-primary-default">
										<Link
				...
				{/* <div className="mt-12 flex justify-center">
					<div className="inline-flex shadow-sm rounded-md">
						<button
							type="button"
							className="py-2 px-4 text-sm font-medium text-white rounded-l-md bg-gray-900 border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-2 focus:ring-primary-default focus:text-primary-default"
						>
							Previous
						</button>
						<button
						...
						<button
							type="button"
							className="py-2 px-4 text-sm font-medium text-white bg-gray-900 border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-2 focus:ring-primary-default focus:text-primary-default"
						>
							2
						</button>
						<button
						...
						<button
							type="button"
							className="py-2 px-4 text-sm font-medium text-white rounded-r-md bg-gray-900 border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-2 focus:ring-primary-default focus:text-primary-default"
						>
							Next
						</button>
					</div>
